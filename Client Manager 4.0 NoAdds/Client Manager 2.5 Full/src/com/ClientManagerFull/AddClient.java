...
public class AddClient extends Activity implements OnClickListener{
	Button boton;
	 TextView tv ;
	...
	public void onClick(View v) {
		...
		((App)getApplication()).darClientManager().addClient(nombre1,clas,phone,mail,addres, type);
	       ((App)(getApplication())).save();
	       Toast.makeText(getApplicationContext(), "Client "+nombre1+" was successfully added",
