...
public class ShowNote extends Activity implements OnClickListener{
    ...
    /** Called when the activity is first created. */
	   ...
	   public void onCreate(Bundle savedInstanceState) {
	       ...
	       subjectView.setText(((App)getApplication()).darClientManager().darClientIndex(((App)getApplication()).darSelected()).darNotes().get(((App)getApplication()).darSelectedNote()).darSubject());
	       showText.setText(((App)getApplication()).darClientManager().darClientIndex(((App)getApplication()).darSelected()).darNotes().get(((App)getApplication()).darSelectedNote()).darText());
	      //layout.removeView(showSubject);
	      //layout.removeView(showText);
	      layout.removeView(add);
	      layout.removeView(text);
	      layout.removeView(boton);
